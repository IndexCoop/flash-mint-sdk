...
export function getExcludedSources(chainId: number) {
  switch (chainId) {
    ...
    case 8453:
      return '0x_RFQ,Aerodrome_V2,AlienBase_Stable,AlienBase_V2,AlienBase_V3,Angle,BaseSwap,BaseX,Clober_V2,DackieSwap_V3,DeltaSwap,Equalizer,Infusion,IziSwap,Kim_V4,Kinetix,Maverick,Maverick_V2,Morphex,Overnight,PancakeSwap_V2,PancakeSwap_V3,RocketSwap,SharkSwap_V2,SoSwap,Solidly_V3,SushiSwap,SushiSwap_V3,SwapBased_V3,Synapse,Synthswap_V2,Synthswap_V3,Thick,Treble,Uniswap_V2,Uniswap_V4,WOOFi_V2,Wrapped_BLT,Wrapped_USDM'
    case 42161:
