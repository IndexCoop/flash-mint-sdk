...
describe('uSOL2x (Base)', () => {
  ...
  const factory: TestFactory = getTestFactoryZeroExV2(7, chainId)
  const indexToken = getTokenByChainAndSymbol(chainId, 'uSOL2x')
  const whale = '0x621e7c767004266c8109e83143ab0Da521B650d6'

  const testCases = [
    { setAmount: '1', inputAmount: '0.5', inputToken: 'ETH' },
    { setAmount: '10', inputAmount: '5', inputToken: 'ETH' },
    { setAmount: '1', inputAmount: '350', inputToken: 'USDC' },
    { setAmount: '10', inputAmount: '3500', inputToken: 'USDC' },
  ]
  ...
  for (const {
    ...
    describe(`SetAmount: ${setAmount} - inputAmount ${inputAmount} ${inputTokenSymbol}`, () => {
      let quote: any
